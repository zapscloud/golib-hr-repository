...
func (p *AttendanceMongoDBDao) ListNew(filter string, sort string, skip int64, limit int64) (utils.Map, error) {
	var results []utils.Map
	var bFilter bool = false
	...
	// Add Lookup stages ================================
	stages = p.appendListLookupsNew(stages)
	// ==================================================
...
func (p *AttendanceMongoDBDao) appendListLookupsNew(stages []bson.M) []bson.M {
