...
func (p *ReportsMongoDBDao) GetLeavePermissionSummary(filter string, aggr string, sort string, skip int64, limit int64) (utils.Map, error) {
	...
	log.Println("Begin - GetLeavePermissionSummary - Reports - Dao", hr_common.DbHrLeaves)
	...
	log.Println("GetLeavePermissionSummary - Parameters", filter, len(filter), sort, len(sort))
	...
	// Add Lookup stages ================================
	stages = p.appendListLookups1(stages)
	// ==================================================
...
func (p *ReportsMongoDBDao) appendListLookups1(stages []bson.M) []bson.M {
